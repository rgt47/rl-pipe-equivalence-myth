...
- metaprogramming
- r-language
description: 'Piping and nesting function calls are semantically different operations.
  A subtle bug in an expression- capturing wrapper reveals how R''s lazy evaluation
  interacts with the pipe operator.
...
![A moment of focus before diving into evaluation semantics.](media/images/ambiance1.png){.img-fluid}
...
semantics.](media/images/ambiance2.png){.img-fluid}
...
learned.](media/images/ambiance3.png){.img-fluid}
